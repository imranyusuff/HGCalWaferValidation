...
static constexpr auto s_tag = "[HGCalWaferValidation]";

TEST_CASE("Standard checks of HGCalWaferValidation", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("HGCalWaferValidation"
